...
/* harmony export */   "retunIndex": () => (/* binding */ retunIndex),
...
const retunIndex = function (clickedChild) {
  for (let i = 0; i < _elements__WEBPACK_IMPORTED_MODULE_0__.tagList.childNodes.length; i++) {
    if (_elements__WEBPACK_IMPORTED_MODULE_0__.tagList.childNodes[i] == clickedChild) {
      return i;
    }
  }
};
...
/* harmony import */ var _classes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes */ "./scripts/classes.js");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions */ "./scripts/functions.js");
...
const addTagObj = new _classes__WEBPACK_IMPORTED_MODULE_2__.AddTag();

(0,_functions__WEBPACK_IMPORTED_MODULE_3__.remainTag)();

_elements__WEBPACK_IMPORTED_MODULE_1__.addInput.addEventListener("keyup", function (e) {
  if (e.key == "Enter" && e.target.value) {
    if ((0,_functions__WEBPACK_IMPORTED_MODULE_3__.remainTag)() <= 9) {
      ...
      if (allowedText.split(",").length <= 10 - (0,_functions__WEBPACK_IMPORTED_MODULE_3__.remainTag)()) {
        if ((0,_functions__WEBPACK_IMPORTED_MODULE_3__.validatedTheText)(allowedText.split(","))) {
...
document.addEventListener("click", function (e) {
  if (e.target.nodeName == "SPAN") {
    if (addTagObj.removeTag((0,_functions__WEBPACK_IMPORTED_MODULE_3__.retunIndex)(e.target.parentElement))) {
      _elements__WEBPACK_IMPORTED_MODULE_1__.tagList.innerHTML = "";
    ...
    if (addTagObj.removeTag((0,_functions__WEBPACK_IMPORTED_MODULE_3__.retunIndex)(e.target.parentElement.parentElement))) {
      _elements__WEBPACK_IMPORTED_MODULE_1__.tagList.innerHTML = "";
      // console.log(addTagObj.render());
      addTagObj.render().forEach((item) => (_elements__WEBPACK_IMPORTED_MODULE_1__.tagList.innerHTML += item));
      (0,_functions__WEBPACK_IMPORTED_MODULE_3__.remainTag)();
