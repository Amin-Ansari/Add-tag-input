...
function retunIndex(clickedChild) {
  for (let i = 0; i < _elements__WEBPACK_IMPORTED_MODULE_1__.tagList.childNodes.length; i++) {
    if (_elements__WEBPACK_IMPORTED_MODULE_1__.tagList.childNodes[i] == clickedChild) {
      return i;
    }
  }
}
